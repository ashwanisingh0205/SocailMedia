...
export const HomeTabIcon:FC<IconProps>=({focused})=>{
    return focused?
    (<TabIconFocused name='Home'/>):(< TabIcon name='Home'/>)

}
export const ProfileTabIcon:FC<IconProps>=({focused})=>{
    return focused?
    (<TabIconFocused name='profile'/>):(< TabIcon name='profile'/>)
